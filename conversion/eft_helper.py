...
class Type14(Record):
    def __init__(self, f, idc=0):
        ...
        self.src = ORI  # Source agency, ATF
        ...
        self.tvps = f.vps  # Transmitted vertical pixel scale
        ...
        # NEW: Populate T14_SEG (Field 14.21) - Segmentation Information
        self.seg = self.get_fingerprint_segmentation()

        # NEW: Populate T14_SQM (Field 14.23) - Quality Metrics
        self.sqm = self.get_fingerprint_quality()

        # NEW: Populate T14_AFM (Field 14.24) - Additional Metadata
        self.afm = self.get_fingerprint_metadata()
    ...
    def _get_dict(self):
        return {
            ...
            "14.012": self.bpx,
            "14.013": self.fgp,
            "14.021": self.seg,   # T14_SEG - Segmentation Information
            "14.023": self.sqm,   # T14_SQM - Quality Metrics
            "14.024": self.afm,   # T14_AFM - Additional Metadata
            "14.999": self.dat
        }

    def get_fingerprint_segmentation(self):
        # Placeholder logic for segmentation data (should be based on actual image processing)
        return "Segmentation data for boundaries"

    def get_fingerprint_quality(self):
        # Placeholder logic for quality metrics (replace with real metrics)
        return "Quality metrics placeholder"

    def get_fingerprint_metadata(self):
        # Placeholder logic for additional fingerprint metadata (replace with real data)
        return "Additional fingerprint metadata"
